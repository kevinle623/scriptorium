...
import { useReportBlogPost } from "@client/hooks/blogs/useReportBlogPost";
...
const BlogPostReportForm = ({ blogPostId }: BlogPostReportProps) => {
...
export default BlogPostReportForm;
